...
// x86_64 syscall names indexed by number.
// Source: /usr/include/x86_64-linux-gnu/asm/unistd_64.h (kernel 6.8)
var syscallNames = [451]string{
	...
	442: "mount_setattr", 443: "quotactl_fd",
	444: "landlock_create_ruleset", 445: "landlock_add_rule",
	446: "landlock_restrict_self",
	447: "memfd_secret", 448: "process_mrelease",
...
func syscallName(id uint32) string {
	...
	if id == 0xFFFFFFFF {
		return "sig-int" // kernel sets orig_rax=-1 when signal interrupts a syscall
	}
