...
type bpfMapSpecs struct {
	...
	QueueConfig *ebpf.MapSpec `ebpf:"queue_config"`
	QueueDepth  *ebpf.MapSpec `ebpf:"queue_depth"`
}
...
type bpfMaps struct {
	...
	QueueConfig *ebpf.Map `ebpf:"queue_config"`
	QueueDepth  *ebpf.Map `ebpf:"queue_depth"`
}
